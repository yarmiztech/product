...
class ProductTemplateAutoBarcode(models.Model):
    ...
    def create(self, vals_list):
        ...
        # if templates.including_price:
        #     print('frtgrtr')
        #     tax_value =  templates.including_price * 15 /(115)
        #     templates.list_price = templates.including_price-tax_value
        return templates

    @api.onchange('barcode','including_price')
